...
# Create main layout with columns (main content on left, chatbot on right)
...
"""
        ...
        # Show visualization and video buttons after analysis is done
...
"""
    ...
    4. **Click** "Generate AI Insights" to get analysis
    ...
    # Footer
    st.markdown("---")
    st.markdown("*Powered by AI Analysis & Lilly Cortex*")

# LillyHelper Chatbot - Right Column
with chat_col:
    st.markdown("### 💬 Assistant")
    st.markdown("*Ask about your RWE data*")
    st.markdown("---")
    ...
    if st.session_state.chatbot_messages:
        if st.button("🗑️ Clear", type="secondary", use_container_width=True, key="clear_chat"):
            st.session_state.chatbot_messages = []
            st.rerun()
